...
inputFilePath = "code/source/gen/ObjectTable.cpp"
objectFilePath = "code/build/build/gen/ObjectTable.cpp.o"
outputFilePath = "code/build/gen/ObjectTable.cpp"
...
def main():
    ...
    if is_uptodate():
        print('Object table already up to date.')
        sys.exit(0)
    ...
    print('Object table generated successfully.')
