...
u32 getFollowTarget(u32 playerID)
{
	return playerTarget[playerID];
}

void setFollowTarget(u32 playerID, u32 targetPlayerID)
{
...
ncp_thumb void disableSharedCamera()
{
	sharedCamera = false;
}
...
ncp_thumb void clearSpectators()
{
	...
	{
		setFollowTarget(playerID, playerID);
...
ncp_call(0x020201B0)
void customFollowOnUpdatePlayerCameraFocus(PlayerBase* self, u32 playerID)
{
	...
	auto updateZoom = [](u32 playerID)
	{
		...
		{
			fx32 distance = Math::lerpFx32(playerZoom[playerID], CoopSym_Stage_zoom[targetPlayerID], 0x80, 0x800, 0x80);
		...
		{
			playerZoom[playerID] = CoopSym_Stage_zoom[targetPlayerID];
		}
	};
...
ncp_repl(0x0200DD78, ".int _ZN10CoopCamera10playerZoomE") // (0x0200DC48) OAM::loadAffineSets
ncp_repl(0x02012028, ".int _ZN10CoopCamera10playerZoomE") // (0x02011F5C) SND::updateScreenBoundaries
ncp_repl(0x0209BA7C, 0, ".int _ZN10CoopCamera10playerZoomE") // (0x0209B7E8) ???::spawnActorsInRange
ncp_repl(0x020AD530, 0, ".int _ZN10CoopCamera10playerZoomE") // (0x020AD270) StageLayout::setBGLayerCoords
ncp_repl(0x020ADA74, 0, ".int _ZN10CoopCamera10playerZoomE") // (0x020AD690) StageLayout::updateCameraCoords
ncp_repl(0x020ADB44, 0, ".int _ZN10CoopCamera10playerZoomE") // (0x020ADADC) StageLayout::setCameraSize
ncp_repl(0x020ADC60, 0, ".int _ZN10CoopCamera10playerZoomE") // (0x020ADB50) StageLayout::setScreenAffine
ncp_repl(0x020ADFD4, 0, ".int _ZN10CoopCamera10playerZoomE") // (0x020ADC74) StageLayout::setScreenCoords
ncp_repl(0x020AF0B8, 0, ".int _ZN10CoopCamera10playerZoomE") // (0x020AEF4C) StageLayout::renderTextures
ncp_repl(0x020B2F8C, 0, ".int _ZN10CoopCamera10playerZoomE") // (0x020B2C58) StageLayout::scrollUpdateGuideTop
ncp_repl(0x020B6E28, 0, ".int _ZN10CoopCamera10playerZoomE") // (0x020B6B5C) StageLayout::animBGVolcanoEruption
ncp_repl(0x020B8BB8, 0, ".int _ZN10CoopCamera10playerZoomE") // (0x020B88BC) StageLayout::cameraUpdateScrolling
ncp_repl(0x020B8C50, 0, ".int _ZN10CoopCamera10playerZoomE") // (0x020B8BDC) StageLayout::getTransitionZoomOffset
ncp_repl(0x020B8D24, 0, ".int _ZN10CoopCamera10playerZoomE") // (0x020B8CA8) StageLayout::getAbsTilesetPosition
ncp_repl(0x020B963C, 0, ".int _ZN10CoopCamera10playerZoomE") // (0x020B9428) StageLayout::updateVScrollFollow
ncp_repl(0x020B99E0, 0, ".int _ZN10CoopCamera10playerZoomE") // (0x020B9900) StageLayout::limitVScroll
ncp_repl(0x020BA32C, 0, ".int _ZN10CoopCamera10playerZoomE") // (0x020BA1B4) StageLayout::limitHScroll
ncp_repl(0x020BACC8, 0, ".int _ZN10CoopCamera10playerZoomE") // (0x020BAA5C) StageLayout::onUpdate

// StageCamera ----------------

ncp_set_call(0x020CE024, 10, getLocalTargetPlayer)
ncp_set_call(0x020CE244, 10, getLocalTargetPlayer)
// //ncp_repl(0x020CE654, 10, ".int _ZN10CoopCamera11localTargetE")
ncp_repl(0x020CE424, 10, ".int _ZN10CoopCamera10playerZoomE")

// Player ----------------

// Fix the player rendering using this->linkedPlayerID instead of Game::localPlayerID
ncp_asmfunc void playerRendering_ASM()
{asm(R"(
...
ncp_repl(0x02118E18, 10, ".int _ZN10CoopCamera11localTargetE") // (0x0211870C) Player::viewTransitState

// Misc ----------------

ncp_repl(0x020F6240, 10, ".int _ZN10CoopCamera10playerZoomE") // (0x020F60F0) LargeFlipFenceRenderer::render
ncp_repl(0x020F7E34, 10, ".int _ZN10CoopCamera10playerZoomE") // (0x020F7D74) PipeBase::onRender
ncp_repl(0x020F89E4, 10, ".int _ZN10CoopCamera10playerZoomE") // (0x020F8854)
ncp_repl(0x02164984, 54, ".int _ZN10CoopCamera10playerZoomE") // (0x02164838) Liquid::updateMain
