...
namespace CoopFixes::Thwomp {

static void fixViewShake(u8 type, StageEntity* self)
{
...
ncp_set_call(0x0213DEE8, 24, fixViewShake)

ncp_repl(0x0213DF30, 24, "MOV R1, R4")
ncp_set_call(0x0213DF38, 24, fixViewShake)
