...
ncp_asmfunc void drawCustomLivesCounter_ASM()
{asm(R"(
ncp_jump(0x020D0B58, 8)
	...
	MOVEQ   R0, R7
	BEQ     0x020D0B5C
	BL      _ZN9CoopFixes8Worldmap22drawCustomLivesCounterEv
	B       0x020D0C38
)");}

ncp_call(0x020D0AB8, 8)
void drawCustomCompletedIcon(BNCL::Object* object, BNCL::Object* maybeBgObj, bool subScreen, const Vec2* scale, s16 rot, u32 xOffset, u32 yOffset, u8 palette, OAM::Flags flags)
{
