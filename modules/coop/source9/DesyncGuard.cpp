...
#ifdef COOP_DESYNC_GUARD_UPDATE_HOOK
	ncp_call(0x02004F18)
...
#ifdef COOP_DESYNC_GUARD_SWITCH_SCENE_HOOK
	ncp_call(0x0201323C)
...
#ifdef COOP_DESYNC_GUARD_DAMAGE_PLAYER_HOOK
	ncp_call(0x02104AB8, 10)
...
#ifdef COOP_DESYNC_GUARD_SWITCH_POWERUP_HOOK
	ncp_jump(0x0212B9AC, 11)
...
#ifdef COOP_DESYNC_GUARD_GET_RANDOM_HOOK
	ncp_jump(0x0200E6F4)
