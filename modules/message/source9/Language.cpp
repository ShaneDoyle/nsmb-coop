...
// Auto-generated from code above
ncp_over(0x020DBA98, 9) u32 over_020DBA98[2] = { 0x805C0010, 0x00002072 };
ncp_over(0x020DBAA0, 9) u32 over_020DBAA0[2] = { 0xC18400D0, 0x00002076 };
ncp_over(0x020DBAA8, 9) u32 over_020DBAA8[2] = { 0xC1C400D0, 0x00002086 };
ncp_over(0x020DBAB0, 9) u32 over_020DBAB0[2] = { 0xC00400D0, 0x00002096 };
ncp_over(0x020DBAB8, 9) u32 over_020DBAB8[2] = { 0x804480F0, 0x000020A6 };
ncp_over(0x020DBAC0, 9) u32 over_020DBAC0[2] = { 0xC1844010, 0x000020A8 };
ncp_over(0x020DBAC8, 9) u32 over_020DBAC8[2] = { 0xC1C44010, 0x000020B0 };
ncp_over(0x020DBAD0, 9) u32 over_020DBAD0[2] = { 0xC0044010, 0x000020B8 };
ncp_over(0x020DBAD8, 9) u32 over_020DBAD8[2] = { 0x80448010, 0x000020C0 };
ncp_over(0x020DBAE0, 9) u32 over_020DBAE0[2] = { 0x40548010, 0xFFFF20C2 };
ncp_over(0x020DBAE8, 9) u32 over_020DBAE8[2] = { 0x807000F8, 0x00002072 };
ncp_over(0x020DBAF0, 9) u32 over_020DBAF0[2] = { 0xC19800B8, 0x00002076 };
ncp_over(0x020DBAF8, 9) u32 over_020DBAF8[2] = { 0xC1D800B8, 0x00002086 };
ncp_over(0x020DBB00, 9) u32 over_020DBB00[2] = { 0xC01800B8, 0x00002096 };
ncp_over(0x020DBB08, 9) u32 over_020DBB08[2] = { 0x805880D8, 0x000020A6 };
ncp_over(0x020DBB10, 9) u32 over_020DBB10[2] = { 0xC19840F8, 0x000020A8 };
ncp_over(0x020DBB18, 9) u32 over_020DBB18[2] = { 0xC1D840F8, 0x000020B0 };
ncp_over(0x020DBB20, 9) u32 over_020DBB20[2] = { 0xC01840F8, 0x000020B8 };
ncp_over(0x020DBB28, 9) u32 over_020DBB28[2] = { 0x805880F8, 0x000020C0 };
ncp_over(0x020DBB30, 9) u32 over_020DBB30[2] = { 0x406880F8, 0x000020C2 };
ncp_over(0x020DB9EC, 9) u32 over_020DB9EC[2] = { 0x01F800F8, 0xFFFF00C3 };
